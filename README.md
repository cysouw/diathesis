...
The easiest way to read the current version is by using the latest HTML or PFD output included in the [`/docs`](docs) directory of this repository. The HTML output can be directly accessed [here](https://cysouw.github.io/diathesis/).
