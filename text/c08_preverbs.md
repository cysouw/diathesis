...
### ~~Ø › SBJ › OBJ~~ : [ –NA | NDA ] Preverb dative causative+accusative {#sec:preverb-dative-causative}
...
### ~~PBJ › SBJ › OBJ~~ : [ PN | NA ] Preverb reversed conversive {#sec:preverb-inverted-passives}
...
### ~~Ø › OBJ~~ : [ N– | NA ] Preverb adjectival accusative addition {#sec:preverb-adjectival-addition}
...
### ~~Ø › OBJ~~ : [ ND– | NDA ] Preverb accusative addition+dative
...
### ~~PBJ › OBJ~~ : [ NP | NA ] Preverb governed applicative {#sec:preverb-governed-applicative}
...
### ~~PBJ › OBJ~~ : [ NP | NA ] Preverb reflexive governed applicative
...
When using the prefix *ver‑* the meaning of this diathesis includes some kind of implicit negation, like with *bitten* 'to ask' vs. *verbitten* 'to not tolerate' [@next].
...
### ~~PBJ › OBJ~~ : [ NDP | NDA ] Preverb governed applicative+dative
...
### ~~ADJ › OBJ~~ : [ NPp | NAD ] Preverb dative+preposition applicative {#sec:preverb-double-applicative}
...
### ~~ADJ › OBJ~~ : [ NAg | NAD ] Preverb possessor-of-accusative to dative {#sec:preverb-possessor-raising}
...
### ~~ADJ › OBJ › ADJ~~ : [ NpA | NAp ] Preverb applicative+*in* antipassive {#sec:preverb-applicative-in-antipassive}
...
### ~~OBJ › OBJ~~ : [ ND | NA ] Preverb dative-to-accusative {#sec:preverb-dative-accusative}
...
### ~~OBJ › OBJ~~ : [ NA | ND ] Preverb accusative-to-dative
...
### ~~OBJ › OBJ › OBJ~~ : [ NDA | NAG ] Preverb dative-to-accusative-to-genitive {#sec:preverb-dative-accusative-genitive}
...
### ~~OBJ › SBJ › OBJ~~ : [ NA | AN ] Preverb accusative inversive {#sec:preverb-accusative-inversive}

The alternation between *wundern* 'to amaze' [@next a] and *bewundern* 'to be in awe' [@next b] reverses the nominative and accusative arguments. Note that the verb *wundern* also allows for a reflexive conversive diathesis [@next c], see [@sec:reflexive-preposition-passive], but that construction cannot function as an intermediate step in this diathesis.
...
### ~~PBJ › SBJ › PBJ~~ : [ NL | LN ] Preverb location inversive {#sec:preverb-location-inversive}
