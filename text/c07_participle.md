...
On closer inspection there turns out to be a large range of light verbs that are grammaticalized into constructions with participles. Some of these are widely acknowledged in the literature, like *sein + Partizip* \Next[a], known as \textsc{Zustandspassiv}, see [@sec:participles-sein-zustandspassiv], and *bekommen + Partizip* \Next[b], known as \textsc{Rezipientenpassiv}, see [@sec:participles-bekommen-passive]. Many others, though, are only sporadically discussed, like *gehören + Partizip* \Next[c], see [@sec:participles-gehoren-anticausative]. This chapter is an attempt to provide a complete survey of light-verb constructions with participles.
