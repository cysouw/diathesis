...
The book consists of three different parts. First, Chapter 1 and 2 discuss the major theoretical considerations that guide the collection and organisation of the data. This is the part to read for insights into the nature of diathesis and sundry topics. Second, Chapter 3 and 4 are the closest that this book has to offer in the way of a conclusion. Each of these chapters present an astonishingly long list summarising major linguistic structures as identified in the rest of the book. These summaries are intended to be a quick entry into the actual German language data, with ample cross-references to the following encyclopaedia. Finally, Chapter 5 to 13 make up the actual encyclopaedia, with separate sub-subsections about individual phenomena. Each of these sub-subsections is a fragment of a research project, sometimes mundane, but once in a while full of unexpected avenues for future research. 

This first chapter summarises the basic definitional properties of diathesis. The next Chapter [-@sec:structure] describes in detail how diatheses are analysed and classified. Chapter [-@sec:summary] presents a summary of the about 80 major German diatheses and proposes German names for those structures. As a small extra, Chapter [-@sec:epithesis] summarises all non-diathetical structures and provides an unconventional approach to the analysis of verbal categories of German. Chapters [-@sec:case] to [-@sec:zuminfinitive] are the main, almost database-like, chapters discussing each sentence structure separately. Each of these chapters has a concise introduction with a detailed discussion of the definition and delimitation of the phenomenon discussed in that chapter
