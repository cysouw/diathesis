...
- Typically, the overt marking introduces a direction into the alternation, i.e. one alternant consists of less/shorter/zero linguistic elements (i.e. 'less marked') and one consists of more/longer/overt linguistic material (i.e. 'more marked'). In some situations the direction of the alternation remains undecidable, i.e. the alternation is equipollent.
...
Second, all obligatory prepositional phrases express lexeme-specific roles. Specifically, some verbs obligatorily require such a location, like *sich befinden* [@next], see [@sec:prepositions-obligatory-local]. More widespread are diatheses that introduce an obligatory location, like the caused-motion diathesis with *waschen* [@nnext], see [@sec:prepositions-partitive-free].
